...
- `.github/workflows/scripts/post_review_comment.py` - Posts review comments
- `.github/workflows/scripts/code_review.py` - Main review orchestration
...
- Run local review: `python3 ./.github/workflows/scripts/code_review.py`
