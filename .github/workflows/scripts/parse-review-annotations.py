...
def main():
    parser = argparse.ArgumentParser(description='Parse AI review and generate GitHub annotations')
    parser.add_argument('review_file', help='Path to the structured review JSON file')
    parser.add_argument('--summary-file', help='Path to output summary markdown (for job summary)')
