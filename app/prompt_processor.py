...
# Assuming ConsoleUI and AnsiColors are accessible relative to this file
...
# Assuming SYSTEM default message is accessible
try:
    from messages import SYSTEM
except ImportError:
    # Define a fallback if messages.py is not found in this context
    SYSTEM = "You are a helpful AI assistant."
    logging.warning("Could not import SYSTEM from messages, using default.")
...
class PromptProcessor:
    ...
    def __init__(self, ui: ConsoleUI, config_dir: str = ".streetrace"):
        """
    ...
    def _read_system_message(self) -> str:
        ...
        return SYSTEM # Use imported or fallback SYSTEM constant
