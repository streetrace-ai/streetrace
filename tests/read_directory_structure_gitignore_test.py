...
class TestReadDirectoryStructure(unittest.TestCase):
    ...
    def test_no_gitignore(self):
        ...
        self.assertIn(os.path.basename(self.temp_dir) + '/root_file.txt', result['files'])
        self.assertIn(os.path.basename(self.temp_dir) + '/root_file.log', result['files'])
    ...
    def test_root_gitignore(self):
        ...
        self.assertNotIn(os.path.basename(self.temp_dir) + '/root_file.log', result['files'])
        self.assertIn(os.path.basename(self.temp_dir) + '/root_file.txt', result['files'])
