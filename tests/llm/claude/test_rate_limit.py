...
class TestClaudeRateLimitHandling(unittest.TestCase):
    ...
    def test_rate_limit_retry(self, mock_log_warning, mock_sleep, mock_client):
        ...
        mock_client.messages.create.side_effect = [rate_limit_error, response_mock]
    ...
    @patch("time.sleep")
    @patch("logging.warning")
    def test_multiple_rate_limit_retries(
        self, mock_log_warning, mock_sleep, mock_client
    ):
