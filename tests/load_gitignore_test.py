...
class TestLoadGitignore(unittest.TestCase):
    ...
    def test_pattern_precedence(self):
        ...
        self.assertTrue(self._is_file_ignored(regular_txt_path, self.nested_dir, result))
        self.assertFalse(self._is_file_ignored(important_txt_path, self.nested_dir, result))
